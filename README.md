...
2. Нажмите **Загрузить распакованное расширение** и выберите папку с этим проектом
   (`D:\Projects\DBB`).
3. Скройте встроенную панель закладок: **Ctrl + Shift + B**.
4. Chrome один раз спросит «Вернуться к Google?» — расширение подменяет страницу
...
За её вид отвечает настройка **«Тёмная страница новой вкладки»** (включена по
умолчанию):

- **включена** — и фон, и панель на этой странице тёмные, независимо от выбранной
  темы и от настройки системы;
- **выключена** — страница следует теме, как и все остальные.
...
| Тёмная страница новой вкладки | вкл / выкл (по умолчанию вкл) |
...
3. Страница новой вкладки пустая, без поиска и ярлыков Chrome, и по умолчанию
   тёмная независимо от темы — это отключается в настройках.
...
- В режиме «сдвигать содержимое вниз» сайт с собственной липкой шапкой
  (`position: fixed; top: 0`) нарисует её под панелью. Для таких сайтов переключите
  режим на «поверх страницы» или добавьте сайт в исключения.
